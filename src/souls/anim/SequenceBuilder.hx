...
class SequenceBuilder
{
    ...
    public function addStep(s:Step):SequenceBuilder
    {
        steps.push(s);
        return this;
    }
    ...
    {
        return addStep(new Call(func));
    }

    public function delay(a:LazyFloat, ?b:LazyFloat):SequenceBuilder
    {
        return addStep(new Delay(Util.desugarRand(a, b)));
    }
    ...
    {
        return addStep(new Tween(otherTopic == null ? topic : otherTopic,
                                 fields, time, ease));
    }
                          ...
                          ?b:LazyFloat):SequenceBuilder
    {
        ...
        return addStep(new Frame(topic, content, Util.desugarRand(a, b)));
    }
